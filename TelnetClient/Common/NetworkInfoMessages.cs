namespace TelnetClient.Common
{
    ...
    public class NetworkInfoMessages
    {
        ...
        public const string CONNECTED = "Подключение создано";
        public const string SERVER_NOT_CONNECTED = "Сервер не запущен или отверг подключение";
        ...
        public const string EMPTY_COMMANDS = "Команды не указаны";
